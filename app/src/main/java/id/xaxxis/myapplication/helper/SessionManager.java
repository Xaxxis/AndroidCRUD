package id.xaxxis.myapplication.helper;
...
public class SessionManager {
    ...
    public void setFrom(String id_user){
        editor.putString("awal", id_user);
        editor.commit();
    }
    public String getFrom(){
        return pref.getString("awal", "");
    }
    public void setDestinations(String id_user){
        editor.putString("destination", id_user);
        editor.commit();
    }
    public String getDestinations(){
        return pref.getString("destination", "");
    }
